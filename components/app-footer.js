class AppFooter extends HTMLElement {
    ...
    connectedCallback() {
        this.shadowRoot.innerHTML = `
            ...
            <footer>
                <div class="footer-content">
                    <!-- Левая часть: Логотип + текст + email -->
                    <div class="footer-left">
                        <div class="footer-logo-wrapper">
                            <svg class="logo-svg" width="128" height="40" viewBox="0 0 128 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="footer-greeting">We'd love to hear your wishes and answer any questions you may have!</p>
                        
                        <div class="footer-contact-info">
                            <h4>Get in touch</h4>
                            <a href="mailto:sales@mraid.io" class="footer-email">sales@mraid.io</a>
                        </div>
                    </div>

                    <!-- Правая часть: Навигация + кнопка вверх -->
        ...
        const scrollTopBtn = this.shadowRoot.querySelector('.scroll-top');
